...
data = {
    ...
    "Animal": [
        ...
        },
        {
            ...
            "size": "Mediano",
            "age": 10,
            "description":"Bingo es un perro mediano, jugueton y agradable con otros animales. Es muy cariñoso y agradecido",
            "short_description": "Bingo es muy cariñoso y agradecido."
        },
        {
            "id": 6,
            "name":"Mojito",
